...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await login(formData.username, formData.password, redirectUrl);
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Or{' '}
            <Link href={`/auth/signup${redirectUrl ? `?redirect=${encodeURIComponent(redirectUrl)}` : ''}`} className="font-medium text-green-600 hover:text-green-500">
